            ...
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-body" style="background: linear-gradient(135deg, #f8fafc 40%, #c6e1f7 100%);">
                    <div class="mb-4 text-center">
                        ...
                        <h3 class="fw-bold mb-0" style="color: #1e5f8a;">ADMINISTRACIÓN DE CLIENTES</h3>
                    </div>
                    <form id="FormClientes" class="p-4 bg-white rounded-4 shadow-sm border">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg rounded-3" id="cliente_direccion" name="cliente_direccion">
                            </div>
                            <div class="col-md-6">
...
<script src="<?= asset('build/js/clientes/index.js') ?>"></script></div>
